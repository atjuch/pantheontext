...
class UltimateSocialDeuxFanCount {
	...
	public static function fan_count_output($networks = '', $rows = '1', $skin = '') {
        ...
        $output .= '<div class="us_fan_count rows-1 us_button us_tumblr_fan_count" data-ajax="" data-network="tumblr"><a href="http://theunicornbooty.tumblr.com/" target="_blank" class="us_tumblr_fan_count_link"> <div class="us_fan_count_button"> <div class="us_fan_count_icon_holder"><i class="us-icon-tumblr"></i></div><div class="us_fan_count_desc">Tumblr</div> </div></a></div>';
        $output .= '<div class="us_fan_count rows-1 us_button us_feedly_fan_count" data-ajax="" data-network="feedly"><a href="/feed/" target="_blank" class="us_feedly_fan_count_link"> <div class="us_fan_count_button"> <div class="us_fan_count_icon_holder"><i class="us-icon-feedpress"></i></div><div class="us_fan_count_desc">Our RSS feed</div> </div></a></div>';
