...
class UltimateSocialDeuxPlacement {
	...
	public function buttons_posts_top($content) {
		...
		if( !( ( $hide_blogpage && is_home() ) || ( $hide_search && is_search() ) || ( $hide_archive && is_archive() ) ) && !in_array($post->ID, $exclude, false) && get_post_type( $post->ID ) == 'post' && ( $networks ) ) {
			...
			$custom_content .= sprintf('<div class="us_posts_top" style="margin-top:%spx;margin-bottom:%spx;">', $margin_top, '1.875em');


				$custom_content .= UltimateSocialDeux::buttons($sharetext, $networks, $url, $align, $count, $native, $skin);

            $custom_content = substr($custom_content,0,strlen($custom_content) -6);

            $custom_content .= '<div class="custom-like-top-wrap"><div class="custom-like-top"><div class="like-title">Like this Article</div><div class="fb-like" data-href="'.get_permalink().'" data-layout="button_count" data-action="like" data-show-faces="false" data-share="false"></div>
</div><div class="custom-like-top"><div class="like-title">Like Unicorn Booty</div><div class="fb-like" data-href="https://facebook.com/unicornbooty/" data-layout="button_count" data-action="like" data-show-faces="false" data-share="false"></div></div></div>';
