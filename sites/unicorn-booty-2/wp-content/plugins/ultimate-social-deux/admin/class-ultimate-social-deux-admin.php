...
class UltimateSocialDeuxAdmin {
	...
	public function options() {
		...
		$colorTab->createOption( array(
			...
			'type' => 'color',
			'default' => UltimateSocialDeux::opt_old('us_hover_color', 'us_styling', '#713b98'),
		) );
		$colorTab->createOption( array(
		...
		$colorTab->createOption( array(
			...
			'type' => 'color',
			'default' => UltimateSocialDeux::opt_old('us_feedly_color', 'us_styling', '#FFB300'),
		) );
		$colorTab->createOption( array(
			'id' => 'us_youtube_color',
		...
		$panelFanCount->createOption( array(
			...
			'type' => 'text',
			'desc' => __( 'Your ID is what comes after', 'ultimate-social-deux' ) . ' ' . 'https://www.youtube.com/channel/',
