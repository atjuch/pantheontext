    ...
    <table class="form-table">
        ...
        <tr valign="top">
            ...
            <div id="tabs-5">
                ...
                <?php $emails = NewsletterControls::get_emails(); ?>
                <table class="widefat">
                    <thead>
                        <tr>
                            <th>Id</th>
                    ...
                    <tbody>
                        <?php foreach ($emails as &$email) { ?>
                            <tr>
                                ...
                                <td><?php if ($email->status == 'sent' || $email->status == 'sending') echo NewsletterControls::print_date($email->send_on); ?></td>
                                <td>
                                ...
                                <td>
                                    ...
                                    <a class="button" href="<?php echo plugins_url('newsletter/do/view.php') . '?id=' . $email->id; ?>" target="_blank">View</a>
                                    <?php $controls->button_confirm('delete', 'Delete', 'Are you sure?', $email->id); ?>
                                </td>
                            </tr>
                        <?php } ?>
                    </tbody>
