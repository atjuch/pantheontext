...
$theme_defaults = array(
    ...
    'theme_header'=>'<p>You\'re receiving this email because you subscribed to it at ' . get_option('blogname') .
        ' as {email}. To read this email online <a href="{email_url}">click hit atere</a>. To modify your subscription <a href="{profile_url}">click here</a>.</p>',
