...
$social_icon_url = plugins_url('newsletter-feed') . '/themes/default/images'; 
?>
<table cellpadding="5" align="center">
    <tr>
        ...
        <?php } ?>
            ...
            <td style="text-align: center; vertical-align: top" align="center" valign="top">
                <a href="<?php echo $theme_options['theme_soundcloud'] ?>"><img src="<?php echo $social_icon_url ?>/soundcloud.png"><br>Youtube</a>
            </td>
        <?php } ?>
            
                    <?php if (!empty($theme_options['theme_flickr'])) { ?>
            <td style="text-align: center; vertical-align: top" align="center" valign="top">
                <a href="<?php echo $theme_options['theme_flickr'] ?>"><img src="<?php echo $social_icon_url ?>/flickr.png"><br>Youtube</a>
            </td>
        <?php } ?>
    </tr>
</table>
