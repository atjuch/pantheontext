...
<div id="tabbed" class="widget">
	<ul id="tabbed-area" class="clearfix">
		<li class="first"><a href="#recent-tabbed"><?php _e('Recent','ubooty'); ?></a></li>
		<li class="second"><a href="#popular-tabbed"><?php _e('Popular','ubooty'); ?></a></li>
		<li class="last"><a href="#random-tabbed"><?php _e('Random','ubooty'); ?></a></li>
	</ul>
