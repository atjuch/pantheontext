...
-----------------------------------------------------------------------------------
 	...
 	Plugin Name: CrumbleMagazine Facebook Subscribe Widget
...
class CrumbleMagazine_fb_subscribe_Widget extends WP_widget{
	...
	function CrumbleMagazine_fb_subscribe_Widget(){
		...
		/* Create the widget. */
		$this->WP_Widget( 'crumble_subscribe_widget' , __( 'CrumbleMagazine: FB Subscribe' , 'crumble' ) , $widget_ops, $control_ops );
