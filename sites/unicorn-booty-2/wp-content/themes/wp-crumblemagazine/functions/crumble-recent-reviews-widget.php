...
-----------------------------------------------------------------------------------
 	...
 	Plugin Name: CrumbleMagazine Recent Reviews Widget For Sidebar
...
class CrumbleMagazine_Recent_Reviews_Widget extends WP_Widget {
	...
	function CrumbleMagazine_Recent_Reviews_Widget()
	{
		...
		/* Create the widget. */
		$this->WP_Widget( 'crumblemagazine_recentreviews_widget', __( 'CrumbleMagazine : Recent Reviews' , 'crumble' ), $widget_ops, $control_ops);
	}
