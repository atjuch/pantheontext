...
-----------------------------------------------------------------------------------
 	...
 	Plugin Name: CrumbleMagazine Popular Posts Widget
...
class CrumbleMagazine_Popular_Post extends WP_Widget {
	...
	function  CrumbleMagazine_Popular_Post() {
		...
		/* Create the widget. */
		$this->WP_Widget( 'crumble-popularpost-widget', __('CrumbleMagazine: Popular Posts', 'crumble'), $widget_ops, $control_ops );
	}
