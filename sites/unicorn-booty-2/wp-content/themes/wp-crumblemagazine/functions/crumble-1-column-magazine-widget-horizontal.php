...
-----------------------------------------------------------------------------------
 	...
 	Plugin Name: CrumbleMagazine 1 Column Magazine Widget
...
class CrumbleMagazine_Widget extends WP_Widget {
	...
	function CrumbleMagazine_Widget()
	{
		...
		/* Create the widget. */
		$this->WP_Widget( 'crumblemagazine-widget', __( 'CrumbleMagazine : 1 Column Magazine Widget' , 'crumble' ), $widget_ops, $control_ops);
	}
