...
-----------------------------------------------------------------------------------
 	...
 	Plugin Name: CrumbleMagazine Related Posts Widget For Single Post
 	Plugin URI: http://www.color-theme.com
 	Description: A widget that show related posts by tags
 	Version: 1.0
 	Author: Zerge
...
class CrumbleMagazine_RelatedPosts_Widget extends WP_widget{
	...
	function CrumbleMagazine_RelatedPosts_Widget(){
		...
		/* Create the widget. */
		$this->WP_Widget( 'crumble_relposts_widget' , __( 'CrumbleMagazine: Related Posts' , 'crumble' ) , $widget_ops, $control_ops );
