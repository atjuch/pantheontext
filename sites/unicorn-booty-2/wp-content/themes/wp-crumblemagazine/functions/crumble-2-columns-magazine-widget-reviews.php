...
-----------------------------------------------------------------------------------
 	...
 	Plugin Name: CrumbleMagazine 2 Columns Reviews Magazine Widget
 	Plugin URI: http://www.color-theme.com
 	Description: A widget that show recent reviews
 	Version: 1.0
 	Author: Zerge
...
class CrumbleMagazine_TwoReviews_Widget extends WP_Widget {
	...
	function CrumbleMagazine_TwoReviews_Widget()
	{
		...
		/* Create the widget. */
		$this->WP_Widget('crumblemagazine-tworeviews-widget', __( 'CrumbleMagazine : 2 Columns Reviews Magazine Widget' , 'crumble' ), $widget_ops, $control_ops);
	}
