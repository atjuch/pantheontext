...
-----------------------------------------------------------------------------------
 	...
 	Plugin Name: CrumbleMagazine 1 Column Review Widget for Magazine
...
class CrumbleMagazine_Review_Widget extends WP_Widget {
	...
	function CrumbleMagazine_Review_Widget()
	{
		...
		/* Create the widget. */
		$this->WP_Widget('crumblemagazine_review', __( 'CrumbleMagazine : 1 Column Review Magazine Widget' , 'crumble' ), $widget_ops, $control_ops);
	}
