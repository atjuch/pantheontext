...
-----------------------------------------------------------------------------------
 	...
 	Plugin Name: CrumbleMagazine Facebook Like Box Widget
...
class CrumbleMagazine_fb_likebox_Widget extends WP_widget{
	...
	function CrumbleMagazine_fb_likebox_Widget(){
		...
		/* Create the widget. */
		$this->WP_Widget( 'crumble_fblikebox_widget' , __( 'CrumbleMagazine: FB Like Box' , 'crumble' ) , $widget_ops, $control_ops );
