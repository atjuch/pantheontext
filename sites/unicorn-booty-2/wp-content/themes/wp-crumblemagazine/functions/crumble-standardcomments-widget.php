...
-----------------------------------------------------------------------------------
 	...
 	Plugin Name: CrumbleMagazine Standard Wordpress Comments Widget
 	Plugin URI: http://www.color-theme.com
 	Description: A widget that show standard comments Wordpress widget
 	Version: 1.0
 	Author: Zerge
...
class CrumbleMagazine_standardcomments_Widget extends WP_widget{
	...
	function CrumbleMagazine_standardcomments_Widget(){
		...
		/* Create the widget. */
		$this->WP_Widget( 'crumble_standardcomments_widget' , __( 'CrumbleMagazine: WP Comments' , 'crumble' ) , $widget_ops, $control_ops );
