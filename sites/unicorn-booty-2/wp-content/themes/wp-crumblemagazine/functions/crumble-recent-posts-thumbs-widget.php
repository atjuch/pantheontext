...
-----------------------------------------------------------------------------------
 	...
 	Plugin Name: CrumbleMagazine Recent Posts Thumbs
...
class CrumbleMagazine_Recent_Posts_Thumbs_Widget extends WP_Widget {
	...
	function CrumbleMagazine_Recent_Posts_Thumbs_Widget()
	{
		...
		/* Create the widget. */
		$this->WP_Widget('crumblemagazine_poststhumbs_widget', __( 'CrumbleMagazine : Recent Posts Thumbs' , 'crumble' ), $widget_ops, $control_ops);
	}
