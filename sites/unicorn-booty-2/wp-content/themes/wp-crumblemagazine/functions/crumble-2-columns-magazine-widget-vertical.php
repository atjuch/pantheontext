...
-----------------------------------------------------------------------------------
 	...
 	Plugin Name: CrumbleMagazine 2 Columns Widget for Magazine
...
class CrumbleMagazine_Vertical_Widget extends WP_Widget {
	...
	function CrumbleMagazine_Vertical_Widget()
	{
		...
		/* Create the widget. */
		$this->WP_Widget( 'crumblemagazine-vertical-widget', __( 'CrumbleMagazine : 2 Columns Magazine Widget' , 'crumble' ), $widget_ops, $control_ops);
	}
