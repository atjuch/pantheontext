...
-----------------------------------------------------------------------------------
 	...
 	Plugin Name: CrumbleMagazine 2 Columns Thumbs Widget for Magazine
 	Plugin URI: http://www.color-theme.com
 	Description: A widget that show recent posts by categories (small thumbs)
 	Version: 1.0
 	Author: Zerge
...
class CrumbleMagazine_Small_Thumbs_Widget extends WP_Widget {
	...
	function CrumbleMagazine_Small_Thumbs_Widget()
	{
		...
		/* Create the widget. */
		$this->WP_Widget( 'crumblemagazine-smallthumbs-widget', __( 'CrumbleMagazine : 2 Columns Thumbs Magazine Widget' , 'crumble' ), $widget_ops, $control_ops);
	}
