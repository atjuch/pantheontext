...
-----------------------------------------------------------------------------------
 	...
 	Plugin Name: CrumbleMagazine Video Widget for Sidebar
 	Plugin URI: http://www.color-theme.com
 	Description: A widget that show video( From Youtube/Vimeo/Dialymotion ).
 	Version: 1.0
 	Author: Zerge
...
class CrumbleMagazine_Video_Widget extends WP_widget{
	...
	function CrumbleMagazine_Video_Widget(){
		...
		/* Create the widget. */
		$this->WP_Widget('crumble_video_widget', __( 'CrumbleMagazine : Video Widget' , 'crumble' ) , $widget_ops, $control_ops );
