...
-----------------------------------------------------------------------------------
 	...
 	Plugin Name: CrumbleMagazine Tabs Widget for Sidebar / Magazine Widgets
 	Plugin URI: http://www.color-theme.com
 	Description: A widget that show tabs in Sidebar and Magazine Widgets
 	Version: 1.0
 	Author: Zerge
...
class CrumbleMagazine_TabsRecent_Widget extends WP_Widget { 
	...
	function CrumbleMagazine_TabsRecent_Widget()
	{
		...
		/* Create the widget. */
		$this->WP_Widget( 'crumblemagazine_tabs_widget', __( 'CrumbleMagazine : Tabs Widget' , 'crumble' ), $widget_ops, $control_ops);
	}
