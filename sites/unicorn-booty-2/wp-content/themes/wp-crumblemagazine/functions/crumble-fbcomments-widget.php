...
-----------------------------------------------------------------------------------
 	...
 	Plugin Name: CrumbleMagazine Facebook Comments Widget
 	Plugin URI: http://www.color-theme.com
 	Description: A widget that show comments from facebook.com
 	Version: 1.0
 	Author: Zerge
...
class CrumbleMagazine_fbc_Widget extends WP_widget{
	...
	function CrumbleMagazine_fbc_Widget(){
		...
		/* Create the widget. */
		$this->WP_Widget( 'crumble_fbc_widget' , __( 'CrumbleMagazine: FB Comments' , 'crumble' ) , $widget_ops, $control_ops );
