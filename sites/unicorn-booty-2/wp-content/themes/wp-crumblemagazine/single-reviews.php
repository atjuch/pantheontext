	...
	<div class="container">
		...
		<div class="eleven columns standard-link">		
			<?php 
				...
				<div id="post-<?php the_ID(); ?>" itemscope itemtype="http://schema.org/Review">	
					<h1 class="single-title" itemprop="itemReviewed"><?php the_title(); ?></h1>
				
					<div class="single-meta-information" itemscope itemtype="http://schema.org/Review">
					
						<ul class="single-post-meta">
							<li class="date-icon">
							  <meta itemprop="datePublished" content="<?php the_time('F d, Y'); ?>"><?php the_time('F d, Y'); ?>
							</li>
							<li class="user-icon" itemprop="author"><?php echo the_author_link(); ?></li>
							<li class="category-icon"><?php the_category(', '); ?></li>
							<li class="comments-icon"><?php comments_number('No Comments','1 Comment','% Comments'); ?></li>
						</ul> <!-- /single-post-meta -->
							...
							if ( has_post_format( 'image' ) || ( !has_post_format( 'image' ) &&  !has_post_format( 'video' ) && !has_post_format( 'audio' ) && !has_post_format( 'gallery' ) )  ) {	                   	?>
								<div class="single-media-thumb"> 							
									<?php
				                    	...
				                    	<a href="<?php echo $large_image_url[0]; ?>" class="zoom" data-rel="prettyPhoto"><img src="<?php echo $small_image_url[0]; ?>" alt="<?php the_title(); ?>" itemprop="image" /></a>				
			...
			<div id="overscore-block">
							<div class="overall-head">
								...
								<div class="wrapper-overall-name">
										...
										<!-- <img src="<?php echo get_template_directory_uri(); ?>/images/stars/<?php echo $score; ?>.png" alt="Score Stars" /> -->
								...
								<div class="wrapper-overall-score" itemscope itemtype="http://schema.org/Review">
										<span itemprop="reviewRating" class="overall-score"><?php echo $score; ?></span>
