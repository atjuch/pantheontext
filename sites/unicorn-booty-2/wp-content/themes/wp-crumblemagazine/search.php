	...
	<div class="container">
		...
		<div class="eleven columns standard-link">		
							...
							<div class="pages-titles">
									<h1><?php _e( 'Results for' , 'crumble' ); ?> "<?php echo get_search_query(); ?>"</h1>
									<div class="clear"></div>
							</div> <!-- /pages-titles -->
				...
				<div id="post-<?php the_ID(); ?>" >	
					...
					<div class="single-meta-information">
						...
						<ul class="single-post-meta">
							...
							<li class="comments-icon"><?php comments_number(__('No Comments','crumble'),__('1 Comment','crumble'),__('% Comments','crumble')); ?></li>
						</ul> <!-- /single-post-meta -->
