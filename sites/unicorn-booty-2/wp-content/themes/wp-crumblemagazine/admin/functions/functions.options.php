...
$of_options[] = array( "name" => __( "Show Read More Links in Blog" , "crumble" ),
					"desc" => __( "Show/Hide read more links" , "crumble" ),
					"id" => $shortname . "_readmore_blog",
					"std" => "Hide",
					"type" => "select",
...
$of_options[] = array( "name" => __( "Banner Code" , "crumble" ),
					"desc" => __( "Paste your Google Adsense (or other) code here." , "crumble" ),
...
$of_options[] = array( "name" => __( "Number Of Items to Show" , "crumble" ),
					"desc" => __( "Enter the number of items to show (blank to show all)" , "crumble" ),
					"id" => $shortname . "_carousel_items",
					"std" => "10",
					"type" => "text"); 
...
$of_options[] = array( "name" => __( "The Post's Tags Slug for slider" , "crumble" ),
					"desc" => __( "Enter the tags slug separated by comma" , "crumble" ),
...
$of_options[] = array(	"name"		=> __( "Twitter Settings" , "crumble" ),
						"type"		=> "heading"
				);
...
$of_options[] = array(	"name"		=> __( "Consumer Key:" , "crumble" ),
						"desc"		=> __( "Enter Your Twitter App Consumer Key" , "crumble" ),
						"id"		=> "{$prefix}consumer_key",
						"std"		=> "",
						"type"		=> "text"
				);

$of_options[] = array(	"name"		=> __( "Consumer Secret:" , "crumble" ),
						"desc"		=> __( "Enter Your Twitter App Consumer Key" , "crumble" ),
...
$of_options[] = array(	"name"		=> __( "Access Token:" , "crumble" ),
						"desc"		=> __( "Enter Your Twitter App Consumer Key" , "crumble" ),
...
$of_options[] = array(	"name"		=> __( "Access Token Secret:" , "crumble" ),
						"desc"		=> __( "Enter Your Twitter App Consumer Key" , "crumble" ),
